...
export const en = {
  ...
  form: {
    ...
    compareButton: 'Calculate Savings',
  ...
  tariff_database: {
    ...
    powerPeakPrice: 'Pot. Peak (€/kW/day)',
    powerOffPeakPrice: 'Pot. Off-Peak (€/kW/day)',
    periods: 'Periods',
    energyPeakPrice: 'Energy Peak (€/kWh)',
    energyFlatPrice: 'Energy Flat (€/kWh)',
    energyOffPeakPrice: 'Energy Off-Peak (€/kWh)',
  },
  error: {
    title: 'Error',
